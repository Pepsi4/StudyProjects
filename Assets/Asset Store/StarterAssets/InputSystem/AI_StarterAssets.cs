...
//     version 1.4.4
//     from Assets/Asset Store/StarterAssets/InputSystem/AI_StarterAssets.inputactions
//
...
public partial class @AI_StarterAssets : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @AI_StarterAssets()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""AI_StarterAssets"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @AI_StarterAssets m_Wrapper;
        public PlayerActions(@AI_StarterAssets wrapper) { m_Wrapper = wrapper; }
